...
\D => не цифровой символ любой
\s => символ пробела (+\t\n\)
\S => непробельный символ (все, кроме пробела, табуляции, каретки...)
\w => цифры и английские буквы, символ нижнего подчеркивания
\W => ![a-zA-Z0-9_], например русская буква
...
{n} - повторить n раз
/\d{3,4}/ - найти где цифра повторяется 3 или 4 раза
